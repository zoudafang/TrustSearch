...
static const uint32_t DATA_LEN = 5124668;   // 512w total num: 5124668=1281167*4, 128w: 1281167
static const uint32_t SEND_BATCH_LEN = 512; // the data size of each batch,that send to enclave
