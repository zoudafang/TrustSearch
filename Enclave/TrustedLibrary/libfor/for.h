...
extern "C"
{
    ...
    static const uint32_t COMPRESS_MIN = 50000;         // the min count of uint32 to be compressed, 用于压缩排序后的数组，小于MIN则不压缩
    static const uint32_t COMPRESS_MIN_UNSORT = 100000000; // the min count of uint32，用于压缩未sort的数组，小于MIN-UNSORT则不压缩
    /**
